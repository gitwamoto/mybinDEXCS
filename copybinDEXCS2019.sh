...
if [ "$trial" -eq 2 ]; then
	...
	wget_from_google_drive 1ibdO3o3rhr5pJZbCMVm_EBEvE93dxCla Desktop/$binDEXCS/0_OPENFOAMメモ.pdf
	wget_from_google_drive 1t2xfDSGqDTfRMJUVDPsUAVyHb26pFQGO Desktop/$binDEXCS/texteditwx.py
	wget_from_google_drive 1NaSexRTG1nVuhEkGd4N5Jw5ciNtT2fMp Desktop/$binDEXCS/0秒以外のフォルダを消す.py
	wget_from_google_drive 1TgG2TiTLFHWTu0793VPj6zS5pnBnNHuX Desktop/$binDEXCS/乱流量を求める.py
	wget_from_google_drive 12kzwZ_4Nho1wl3hfRrNoqerGRzZiqUrj Desktop/$binDEXCS/力と力のモーメントを求める.py
	wget_from_google_drive 1MUQTBnGCNQREpAEV5Jl6_7YjZcjD2VEC Desktop/$binDEXCS/logファイルをプロット.py
	wget_from_google_drive 1K51YlihL7x2X79uLDw5qYLVnUoJium64 Desktop/$binDEXCS/improveMeshQualityを実行.py
	wget_from_google_drive 16bfQ3D586ggseG7FWNDKUDJq3vaGpbLx Desktop/$binDEXCS/snappyHexMeshを実行.py
	wget_from_google_drive 1RE1BH_65MAKTVyO_VxevC-Sp47d5V5dS Desktop/$binDEXCS/半角に出来る文字は全て半角に.py
	wget_from_google_drive 1LGDfb2vL56kZm0_or1vBTjS7quEqQQA0 Desktop/$binDEXCS/cartesianMeshを実行.py
	wget_from_google_drive 1HeQJ0AJmbN8a_4CPM8Y49zs8aTNvDg8K Desktop/$binDEXCS/0秒以外を除いてコピーを作る.py
	wget_from_google_drive 1A0uyOURMIFbheKTBJ9zHNAyBtMIIhwDj Desktop/$binDEXCS/2次元メッシュに.py
	wget_from_google_drive 1DXqNiwm709OXprG0EUJTPC7WmO9GtPJV Desktop/$binDEXCS/Qと渦度を求める.py
	wget_from_google_drive 1R66pYPSKnEBXbvEM7NTAIPanbrYpB2H4 Desktop/$binDEXCS/paraFoamを実行.py
	wget_from_google_drive 1CeY1ZaVlnGQVW6kEEREYXtjRyf6pME45 Desktop/$binDEXCS/メッシュを細かく.py
	wget_from_google_drive 1Sxw161qNy10fnNWrg_WNJA4CBMDG73kt Desktop/$binDEXCS/patchを平面に.py
	wget_from_google_drive 1X_SxyrE-vlh4p6vO1G3gV1wTrunk6WXr Desktop/$binDEXCS/blockMeshを実行.py
	wget_from_google_drive 1ANNFRSSBEugHp4vrVHwTLuwaUvlNuszx Desktop/$binDEXCS/0秒フォルダにpatchを追加する.py
	wget_from_google_drive 1DxCTS5ToXtmIo5GdyC8FG6s37AFsAbh8 Desktop/$binDEXCS/他の結果からコピー.py
	wget_from_google_drive 1-H684qnDwl-EmRExJtyCWypaCTMJ62Sj Desktop/$binDEXCS/結果を抽出.py
	wget_from_google_drive 1mIvIObosYcNCOU640TE8Ax10lKP6eF4c Desktop/$binDEXCS/流量を求める.py
	wget_from_google_drive 1ffeV5okgJrTQk6GnDAjCyhkWSv-cdBOo Desktop/$binDEXCS/include文を取り除く.py
	wget_from_google_drive 1B7lG9V_qXtcB4RzXD0vzoO3B8WaAU2Qc Desktop/$binDEXCS/壁面熱流束を求める.py
	wget_from_google_drive 1X4tlTjzVH-M2nEMNGTQhLzAAZbRksEF8 Desktop/$binDEXCS/patchをまとめる.py
	wget_from_google_drive 10yh5BzoVpBda6QnGYpQuoN2rkq_wCZuJ Desktop/$binDEXCS/patchの面積平均または積分.py
	wget_from_google_drive 1a8QLutBlKG_csbmKF5T9YDWMdMP47KgY Desktop/$binDEXCS/yPlusを求める.py
	wget_from_google_drive 1iUvcPvteOQCaZ1cODWa9Q8a9sZZRCbIc Desktop/$binDEXCS/並列計算結果をまとめる.py
	wget_from_google_drive 1GgFRTlZU94HqxSz5UDaXYePXM8VYcpTQ Desktop/$binDEXCS/計算.py
	wget_from_google_drive 1SBZDsoDg5FZwJ5WxrZpNl9lRj2wiivK8 Desktop/$binDEXCS/連続計算雛形.py
	wget_from_google_drive 17VbrNkcfWl0k0BrfTjftSDBBOoGvOL1B Desktop/$binDEXCS/境界条件の雛形をコピー.py
	wget_from_google_drive 13KKe-WzaU-U4dCnX_I6Tn8VLnWuBvP2j Desktop/$binDEXCS/境界条件あれこれ.txt
	wget_from_google_drive 1liQQacJyMh6mL6MH62kV55vkJ5rpR70V Desktop/$binDEXCS/ミリをメートルに.py
	wget_from_google_drive 1OW0Xpm55YTlzh0n8QmPP_MWIqG9F3IxT Desktop/$binDEXCS/include文を差し込む.py
	wget_from_google_drive 1GCGZKAeXEidG4_7HhtN2xlZdfNV01LQO Desktop/$binDEXCS/時間平均流れ場を作る.py
	wget_from_google_drive 1dB-ce6-5HfDbjVLbbxK0atPuZbVResVU Desktop/$binDEXCS/インデント.py
	wget_from_google_drive 1g8Kd9ps4vlhV3Z1Aic9qo473RSiP65aS Desktop/$binDEXCS/setFieldsを実行.py
	wget_from_google_drive 1Wl5iL2mU4PfdHjy4SX4rhYIcPDojb859 Desktop/$binDEXCS/壁面せん断応力を求める.py
	wget_from_google_drive 1Xmu6YFbM-XbHxhr4hDzupltKNE0SnG6T Desktop/$binDEXCS/utilities/setComment.py
	wget_from_google_drive 16KDgHM3CG-ahNjmhiEfL0022OcnRQKPl Desktop/$binDEXCS/utilities/showDir.py
	wget_from_google_drive 1ZFOmkz5amytyxo1217uDkFdkhY_mXEyg Desktop/$binDEXCS/utilities/dictFormat.py
	wget_from_google_drive 1PNwgXDkNubCNNzjyapec_Jx5hG8m_TQn Desktop/$binDEXCS/utilities/folderTime.py
	wget_from_google_drive 12Y3pOduxbIr95XHxVO5cyKsqFSGsunte Desktop/$binDEXCS/utilities/listFile.py
	wget_from_google_drive 1fLfEWqTLd2ben62wnSdecSc_-9lxEz6_ Desktop/$binDEXCS/utilities/__init__.py
	wget_from_google_drive 1DtoaZELndH9TfzrVenZ6qXEhSOLajfRX Desktop/$binDEXCS/utilities/appendEntries.py
	wget_from_google_drive 1aB7Hz17kmGjS2m615iIjEqyOYr0zTFl- Desktop/$binDEXCS/utilities/dakuten.py
	wget_from_google_drive 1pjVjNJli_EIyk7FE6jd27hHQdHDe-9a1 Desktop/$binDEXCS/utilities/dictParse.py
	wget_from_google_drive 1-Y2r3vcejRCxAu0yjiXbHi71cOTHMuMM Desktop/$binDEXCS/utilities/setFuncsInCD.py
	wget_from_google_drive 1EY6MKVApv1Z1o17mar4LKri0_q4dIh4F Desktop/$binDEXCS/utilities/ofpolymesh.py
	wget_from_google_drive 1AUCTSWJmbvDmElW7LR-R851Pjub07_AL Desktop/$binDEXCS/utilities/findMaxMin.py
	wget_from_google_drive 1piTTcac5_95W1Jxzu_fLufnEjY_rBU9m Desktop/$binDEXCS/utilities/misc.py
	wget_from_google_drive 1oLrfU9htGKnaANbAGp9NJNQf9je4r8fW Desktop/$binDEXCS/utilities/rmObjects.py
	chmod -R +x Desktop/"$binDEXCS"/*.py
